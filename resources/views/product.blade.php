        ...
        <div class="max-w-7xl px-4 mx-auto 2xl:px-0">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
                    <img class="w-full block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg"
                        alt="" />
                </div>
                ...
                <div class="mt-6 sm:mt-8 lg:mt-0">
                    ...
                    <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                        <a href="https://wa.me/6285606359701" title=""
                            class="text-white mt-4 sm:mt-0 bg-[#73AF6F] hover:bg-[#6AA867] focus:ring-4 focus:ring-[#6AA867] font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none flex items-center justify-center"
                            role="button">
                    ...
                    <div id="accordion-collapse" data-accordion="collapse"
                        ...
                        <div id="accordion-collapse-body-1"
                            ...
                            <div class="p-4 md:p-5">
                                <p class="mb-2 text-body">{{ $tool['deskripsi'] }}</p>
                            </div>
                        </div>
                        ...
                        <div id="accordion-collapse-body-2"
                            ...
                            <div class="p-4 md:p-5">
                                <p class="mb-2 text-body">Flowbite is first conceptualized and designed using the Figma
                                    software
                                    so everything you see in the library has a design equivalent in our Figma file.</p>
                                <p class="text-body">Check out the <a href="https://flowbite.com/figma/"
                                        class="text-fg-brand hover:underline">Figma design system</a> based on the utility
                        ...
                        <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
                            <div class="p-4 md:p-5 border border-t-default border-b-0 border-x-0">
                                <ul class="space-y-2">
                                    ...
                                    <li>
                                        <span class="font-semibold">Harga per Minggu:</span>
                                        Rp. {{ number_format($tool['harga_per_minggu'], 0, ',', '.') }}
                                    </li>

                                    <li>
                                        <span class="font-semibold">Harga per Bulan:</span>
